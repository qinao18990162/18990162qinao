...
//                R.color.red, R.color.orange, R.color.green, R.color.blue);
    ...
    private void initRecyclerStaggered() {
        ...
        // 构建一个服装列表的瀑布流适配器
        RecyclerStaggeredAdapter adapter = new RecyclerStaggeredAdapter(this, PhoneInfo.getDefaultStag());
        // 设置瀑布流列表的点击监听器
...
//    }
    ...
    private void initRecyclerGrid() {
        ...
        // 构建一个市场列表的网格适配器
        RecyclerGridAdapter adapter = new RecyclerGridAdapter(this, PhoneInfo.getDefaultGrid());
        // 设置网格列表的点击监听器
        adapter.setOnItemClickListener(adapter);
        // 设置网格列表的长按监听器
        adapter.setOnItemLongClickListener(adapter);
