...
import com.example.finalwork.bean.PhoneInfo;
...
public class ShoppingCartActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_shopping_channel) { // 点击了“商场”按钮
            // 跳转到手机商场页面
            Intent intent = new Intent(this, com.example.finalwork.ShoppingListActivity.class);
    ...
    private Runnable mPopupMenu = new Runnable() {
        ...
        public void run() {
            ...
            // 构建购物车商品列表的适配器对象
            CartAdapter adapter = new CartAdapter(com.example.finalwork.ShoppingCartActivity.this, mCartArray);
            // 给lv_cart设置商品列表适配器
            lv_cart.setAdapter(adapter);
            // 重新设置lv_cart的点击监听器
            lv_cart.setOnItemClickListener(com.example.finalwork.ShoppingCartActivity.this);
            // 重新设置lv_cart的长按监听器
            lv_cart.setOnItemLongClickListener(com.example.finalwork.ShoppingCartActivity.this);
        }
    };
